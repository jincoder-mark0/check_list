"""
Power_Report.rpt 리포트 파서

이 모듈은 Power_Report.rpt (혹은 Power_Data.rpt) 파일을 읽어서 Q13, Q14, Q20 분석에 쓰이는
...
class PowerReportParser(BaseParser):
    """ Power_Report.rpt 파일 파싱 클래스 """

    def parse(self, file_path: str) -> Dict[str, Any]:
        """
        Power_Report.rpt 파일 파싱 후 전력 및 온도 데이터 반환
        ...
        Args:
            file_path: Power_Report.rpt 절대경로
